...
///////////////////////////////////////////////////////////////////////////////
 function myDisplayer(some) {
  ...
  //
  function myoccurence(str, ch, myCallback) {
    var count = str.split(ch).length - 1;
    myCallback(count);
  }
  var ch = 'ab';
  var str = 'abbbaaaabaaabb';
  //le function  mydisplayer est passe comme un argument 
  myoccurence(str, ch, myDisplayer);
/////////////////////////////////////////////////////////////////////////////
...
division(5, 0).then((res) => console.log("resultat : " + res))
    .catch((error) => console.log(error));
console.log("fin");
// remarque : les promesse s'excute de maniere asynchrone 
...
//// Cette fois- ci ON A OBLIGE DE WAIT SOMME() FOR EXECUTING POWER FUNCTION 
